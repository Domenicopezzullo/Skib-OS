...
static inline unsigned int get_pitch() {
    return *(unsigned int*)0x0504;
}

void draw_time(int x, int y, unsigned int fg, unsigned int bg);
void print_hex(int x, int y, char* prefix, int val, unsigned int fg, unsigned int bg, int size);
void put_pixel(int x, int y, unsigned int color);
void clear_screen(unsigned int color);
void draw_char(int x, int y, char c, unsigned int fg_color, unsigned int bg_color, int size);
void draw_string(int x, int y, char* str, unsigned int fg, unsigned int bg, int size);
